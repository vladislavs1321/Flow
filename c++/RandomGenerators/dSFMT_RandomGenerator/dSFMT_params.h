...
#if DSFMT_MEXP == 521
  #include "dSFMT_params521.h"
#elif DSFMT_MEXP == 1279
  #include "dSFMT_params1279.h"
#elif DSFMT_MEXP == 2203
  #include "dSFMT_params2203.h"
#elif DSFMT_MEXP == 4253
  #include "dSFMT_params4253.h"
#elif DSFMT_MEXP == 11213
  #include "dSFMT_params11213.h"
#elif DSFMT_MEXP == 19937
  #include "dSFMT_params19937.h"
#else
#ifdef __GNUC__
