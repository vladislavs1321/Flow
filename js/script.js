            ...
            success: function(responce) {
                ...
                if (responce.success === true) {
                    ...
                    if ($.find('.vars').length === 0) {
                        ...
                        var validators = [];
                        if ($('#w0').length) {
                            validators.push(liveValidation("w0").add(Validate.Numericality, {minimum: 0.0000001, maximum: 10}));
                        }
                        if ($('#z0').length) {
                        ...
                        if ($('#diffusion').length) {
                            validators.push(liveValidation("diffusion").add(Validate.Numericality, {minimum: 1e-12, maximum: 2.8e-10}));
                        }
                        if ($('#Brightness').length) {
                            validators.push(liveValidation("Brightness").add(Validate.Numericality, {minimum: 10000, maximum: 150000, onlyInteger: true}));
                        }
                        if ($('#Neff').length) {
                            validators.push(liveValidation("Neff").add(Validate.Numericality, {minimum: 0.01, maximum: 5}));
                        }
